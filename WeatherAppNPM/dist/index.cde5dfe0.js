...
})({"2Yh4E":[function(require,module,exports) {
...
function LoadLast() {
    ...
    (0, _domJsDefault.default).mainInput.placeholder = LastCity;
    GetWeather();
}
document.querySelector(".categories__bar").onclick = function(event) {
    (0, _domJsDefault.default).categories[0].classList.remove("select");
    (0, _domJsDefault.default).categories[1].classList.remove("select");
    (0, _domJsDefault.default).categories[2].classList.remove("select");
...
(0, _domJsDefault.default).mainForm.addEventListener("submit", (e)=>{
    e.preventDefault();
    (0, _domJsDefault.default).likeIcon.classList.remove("fill");
    GetWeather();
});
async function GetWeather() {
    try {
        const cityName = (0, _domJsDefault.default).mainInput.value.toLowerCase().capitalize();
        const url = `${serverUrl}?q=${cityName}&appid=${apiKey}&units=metric`;
        const response = await fetch(url);
        const List = await response.json();
        console.log(List);
        LastCity = List.name;
        (0, _domJsDefault.default).mainInput.placeholder = List.name;
        LocalStorageLast();
        RenderDetalis(List);
        RenderMain(List);
        (0, _domJsDefault.default).mainInput.value = "";
    } catch (e) {
        if ((0, _domJsDefault.default).mainInput.value.toLowerCase() == "") {
            Locations.forEach((lock)=>{
                console.log(lock);
                if (lock == (0, _domJsDefault.default).titleForLike.textContent) {
                    (0, _domJsDefault.default).likeIcon.classList.add("fill");
                    console.log("da");
                }
            });
...
function RenderMain(List) {
    (0, _domJsDefault.default).mainSity[0].textContent = (0, _domJsDefault.default).mainInput.value.toLowerCase().capitalize();
    (0, _domJsDefault.default).mainSity[1].textContent = (0, _domJsDefault.default).mainInput.value.toLowerCase().capitalize();
    (0, _domJsDefault.default).mainSity[2].textContent = (0, _domJsDefault.default).mainInput.value.toLowerCase().capitalize();
    (0, _domJsDefault.default).mainDegree.textContent = List.main.temp;
    Locations.forEach((lock)=>{
        if (lock == (0, _domJsDefault.default).titleForLike.textContent) {
            (0, _domJsDefault.default).likeIcon.classList.add("fill");
            console.log("da");
...
function RenderDetalis(List) {
    (0, _domJsDefault.default).detalisTemp.textContent = "Температура: " + List.main.temp;
    (0, _domJsDefault.default).detalisLikes.textContent = "Ощущается: " + List.main.feels_like;
    (0, _domJsDefault.default).detalisWeather.textContent = "Погода: " + List.weather[0].main;
    (0, _domJsDefault.default).detalisSunrise.textContent = "Восход: " + ConvertTime(List.sys.sunrise);
    (0, _domJsDefault.default).detalisSunset.textContent = "Закат: : " + ConvertTime(List.sys.sunset);
}
...
(0, _domJsDefault.default).placeForLoc.addEventListener("click", function(event) {
...
(0, _domJsDefault.default).placeForLoc.addEventListener("click", function(event) {
    if (event.target.classList.contains("location-txt")) {
        ...
        (0, _domJsDefault.default).mainInput.value = searchName[0].textContent;
        (0, _domJsDefault.default).likeIcon.classList.remove("fill");
        GetWeather();
        render();
    }
...
(0, _domJsDefault.default).likeIcon.onclick = function(e) {
    e.target.classList.toggle("fill");
    if ((0, _domJsDefault.default).likeIcon.classList.contains("fill")) {
        Locations.push((0, _domJsDefault.default).titleForLike.textContent);
        LocalStorageSave();
        render();
    } else {
        Locations = Locations.filter((el)=>el != (0, _domJsDefault.default).titleForLike.textContent);
        LocalStorageSave();
        render();
    }
...
function render() {
    (0, _domJsDefault.default).placeForLoc.replaceChildren();
    Locations.forEach((lock)=>{
        const newElem = newElement(lock);
        (0, _domJsDefault.default).placeForLoc.appendChild(newElem);
    });
}
LoadLast();
render();

},{"./DOM.js":"aClWA","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","date-fns":"9yHCA"}],"aClWA":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"../_lib/requiredArgs/index.js":"9wUgQ","../constants/index.js":"iOhcx","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["2Yh4E","jUTag"], "jUTag", "parcelRequire94c2")
