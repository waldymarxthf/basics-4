...
const detailsFeels = document.querySelector(".details_fells");
...
const forecastDate = document.querySelectorAll(".forecast_date");
const forecastTime = document.querySelectorAll(".forecast_time");
