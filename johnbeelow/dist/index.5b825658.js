...
})({"14wWz":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "1d1bcaf55b825658";
"use strict";
...
},{}],"ELZjx":[function(require,module,exports) {
var _uiElementsJs = require("./module/ui_elements.js");
var _businessLogicJs = require("./module/business-logic.js");
document.addEventListener("DOMContentLoaded", ()=>{
    (0, _uiElementsJs.UI_ELEMENTS).LOADER_DISCONECTED.style.display = "none";
});
document.addEventListener("DOMContentLoaded", (0, _businessLogicJs.handleContentLoaded));
for (let button of (0, _uiElementsJs.UI_ELEMENTS).BUTTONS_ALL)button.addEventListener("click", (0, _businessLogicJs.changeActiveButton));
(0, _uiElementsJs.UI_ELEMENTS).INPUT_FORM.addEventListener("submit", (event)=>{
    event.preventDefault();
    (0, _businessLogicJs.handleSendingData)((0, _uiElementsJs.UI_ELEMENTS).INPUT_TEXT.value);
    (0, _uiElementsJs.animateIcon)();
    (0, _uiElementsJs.clearInput)();
});
(0, _uiElementsJs.UI_ELEMENTS).LIKE.addEventListener("click", (event)=>{
    event.preventDefault();
    (0, _businessLogicJs.getToggleLikeAction)();
});
window.addEventListener("online", ()=>{
    (0, _uiElementsJs.UI_ELEMENTS).LOADER_DISCONECTED.style.display = "none";
});
window.addEventListener("offline", ()=>{
    (0, _uiElementsJs.UI_ELEMENTS).LOADER_DISCONECTED.style.display = "flex";
});

},{"./module/ui_elements.js":"16ipr","./module/business-logic.js":"eexCd"}],"16ipr":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "UI_ELEMENTS", ()=>UI_ELEMENTS);
parcelHelpers.export(exports, "CLASS", ()=>CLASS);
parcelHelpers.export(exports, "CREATE_ELEMENT", ()=>CREATE_ELEMENT);
parcelHelpers.export(exports, "TOGGLE_LIKE", ()=>TOGGLE_LIKE);
parcelHelpers.export(exports, "animateIcon", ()=>animateIcon);
...
},{}],"eexCd":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "handleContentLoaded", ()=>handleContentLoaded);
parcelHelpers.export(exports, "handleSendingData", ()=>handleSendingData);
parcelHelpers.export(exports, "repeatRequest", ()=>repeatRequest);
parcelHelpers.export(exports, "renderFavorite", ()=>renderFavorite);
parcelHelpers.export(exports, "getToggleLikeAction", ()=>getToggleLikeAction);
parcelHelpers.export(exports, "changeActiveButton", ()=>changeActiveButton);
var _localstorageJs = require("./localstorage.js");
var _utilsJs = require("./utils.js");
var _apiJs = require("./API.js");
var _uiElementsJs = require("./ui_elements.js");
function handleContentLoaded() {
    repeatRequest((0, _localstorageJs.currentCity));
    (0, _localstorageJs.cityFavoriteList) === (0, _apiJs.ERROR).EMPTY_VALUE || renderFavorite();
}
const handleSendingData = (input)=>{
    const output = (0, _localstorageJs.checkInput)(input);
    if (!output) return;
...
const getWeatherData = async (city)=>{
    try {
        const response = await fetch(`${(0, _apiJs.API).URL_WEATHER}?q=${city}&appid=${(0, _apiJs.API).KEY}`);
...
const renderWeather = ({ weather , main , sys , name  })=>{
    const data = {
        img: `${(0, _apiJs.API).URL_IMG}/${weather[0].icon}${(0, _apiJs.API).IMG_SIZE_2X}`,
        feelsLike: (0, _utilsJs.convertKelvinToCelsius)(main.feels_like),
        temperature: (0, _utilsJs.convertKelvinToCelsius)(main.temp),
        sunrise: (0, _utilsJs.convertUnixToTime)(sys.sunrise),
        sunset: (0, _utilsJs.convertUnixToTime)(sys.sunset),
        weather: weather[0].main
    };
    updateTemperature(data);
    updateWeatherData(data);
    (0, _localstorageJs.updateCurrentCity)(name);
    checkLikeDisplay(name);
    updateCityList(name);
};
const updateTemperature = ({ feelsLike , temperature  })=>{
    (0, _uiElementsJs.UI_ELEMENTS).FEELS_LIKE.textContent = feelsLike;
    (0, _uiElementsJs.UI_ELEMENTS).TEMPERATURE.forEach((element)=>element.classList.contains((0, _uiElementsJs.CLASS).TEMPERATURE) ? element.textContent = temperature : null);
};
const updateWeatherData = ({ img , weather , sunrise , sunset  })=>{
    (0, _uiElementsJs.UI_ELEMENTS).NOW_WEATHER_ICON.src = img;
    (0, _uiElementsJs.UI_ELEMENTS).DETAILS_WEATHER.textContent = weather;
    (0, _uiElementsJs.UI_ELEMENTS).DETAILS_SUNRISE.textContent = sunrise;
    (0, _uiElementsJs.UI_ELEMENTS).DETAILS_SUNSET.textContent = sunset;
};
const checkLikeDisplay = (name)=>{
    (0, _localstorageJs.isCityExist)(name) ? (0, _uiElementsJs.TOGGLE_LIKE).ACTIVE() : (0, _uiElementsJs.TOGGLE_LIKE).INACTIVE();
};
const updateCityList = (name)=>{
    (0, _uiElementsJs.UI_ELEMENTS).ACTIVE_CITY.forEach((element)=>{
        element.textContent = name;
    });
};
const getForecastData = async (city)=>{
    (0, _uiElementsJs.UI_ELEMENTS).LOADER.style.display = "flex";
    try {
        const response = await fetch(`${(0, _apiJs.API).URL_FORECAST}?q=${city}&appid=${(0, _apiJs.API).KEY}`);
        const data = await response.json();
        renderForecast(data);
    } catch (error) {
        console.error(error);
    } finally{
        (0, _uiElementsJs.UI_ELEMENTS).LOADER.style.display = "none";
    }
};
// Рекурсия:
const renderForecast = ({ list  })=>{
    const renderForecastBlock = (index)=>{
        ...
        const data = {
            feelsLike: (0, _utilsJs.convertKelvinToCelsius)(element.main.feels_like),
            temperature: (0, _utilsJs.convertKelvinToCelsius)(element.main.temp),
            img: `${(0, _apiJs.API).URL_IMG}/${element.weather[0].icon}.png`,
            date: (0, _utilsJs.convertUnixToDate)(element.dt),
            time: (0, _utilsJs.convertUnixToTime)(element.dt),
            weather: element.weather[0].main
        };
        createForecastBlock(data);
        renderForecastBlock(index + 1);
    };
    (0, _uiElementsJs.UI_ELEMENTS).FORECAST_TAB_LIST.replaceChildren();
    renderForecastBlock(0);
};
const createForecastBlock = ({ date , time , temperature , weather , feelsLike , img  })=>{
    const containerBlock = (0, _uiElementsJs.CREATE_ELEMENT).DIV();
    const spanDate = (0, _uiElementsJs.CREATE_ELEMENT).SPAN();
    const spanTime = (0, _uiElementsJs.CREATE_ELEMENT).SPAN();
    const spanTemperature = (0, _uiElementsJs.CREATE_ELEMENT).SPAN();
    const spanWeather = (0, _uiElementsJs.CREATE_ELEMENT).SPAN();
    const spanFeelsLike = (0, _uiElementsJs.CREATE_ELEMENT).SPAN();
    const imgIcon = (0, _uiElementsJs.CREATE_ELEMENT).IMG();
    containerBlock.className = (0, _uiElementsJs.CLASS).FORECAST_BLOCK;
    spanDate.className = (0, _uiElementsJs.CLASS).FORECAST_DATE;
    spanTime.className = (0, _uiElementsJs.CLASS).FORECAST_TIME;
    spanTemperature.className = (0, _uiElementsJs.CLASS).FORECAST_TEMPERATURE;
    spanWeather.className = (0, _uiElementsJs.CLASS).FORECAST_WEATHER;
    spanFeelsLike.className = (0, _uiElementsJs.CLASS).FORECAST_FEELS_LIKE;
    imgIcon.className = (0, _uiElementsJs.CLASS).FORECAST_IMG;
    ...
    imgIcon.src = img;
    (0, _uiElementsJs.UI_ELEMENTS).FORECAST_TAB_LIST.append(containerBlock);
...
const renderFavorite = ()=>{
    (0, _uiElementsJs.UI_ELEMENTS).FAVORITES_LIST.replaceChildren();
    (0, _localstorageJs.cityFavoriteList).forEach((name)=>createFavoriteCity(name));
};
const createFavoriteCity = (name)=>{
    const containerCity = (0, _uiElementsJs.CREATE_ELEMENT).DIV();
    const cityName = (0, _uiElementsJs.CREATE_ELEMENT).A();
    const deleteButton = (0, _uiElementsJs.CREATE_ELEMENT).BUTTON();
    const whiteSpace = (0, _uiElementsJs.CREATE_ELEMENT).SPAN();
    cityName.textContent = name;
    cityName.className = (0, _uiElementsJs.CLASS).CITY_INACTIVE;
    whiteSpace.textContent = " ";
    deleteButton.textContent = "✖";
    deleteButton.className = (0, _uiElementsJs.CLASS).DELETE_CITY;
    (0, _uiElementsJs.UI_ELEMENTS).FAVORITES_LIST.append(containerCity);
    ...
    deleteButton.addEventListener("click", ()=>{
        (0, _localstorageJs.deleteCity)(name);
        checkLikeDisplay(name);
        renderFavorite();
    });
};
const getToggleLikeAction = ()=>{
    if ((0, _uiElementsJs.UI_ELEMENTS).LIKE.classList.contains((0, _uiElementsJs.CLASS).ACTIVE_LIKE)) {
        (0, _localstorageJs.deleteCity)((0, _localstorageJs.currentCity));
        checkLikeDisplay((0, _localstorageJs.currentCity));
        renderFavorite();
        return;
    }
    if (!(0, _uiElementsJs.UI_ELEMENTS).LIKE.classList.contains((0, _uiElementsJs.CLASS).ACTIVE_LIKE)) {
        (0, _localstorageJs.addCity)((0, _localstorageJs.currentCity));
        checkLikeDisplay((0, _localstorageJs.currentCity));
        renderFavorite();
        return;
    }
...
const changeActiveButton = (event)=>{
    ...
    (0, _uiElementsJs.UI_ELEMENTS).BUTTONS_ALL.forEach((button)=>button === buttonClicked ? button.classList.add((0, _uiElementsJs.CLASS).ACTIVE_BUTTON) : button.classList.remove((0, _uiElementsJs.CLASS).ACTIVE_BUTTON));
    changeTabView(buttonClicked.dataset.tab);
};
const changeTabView = (tabButton)=>{
    for (const element of (0, _uiElementsJs.UI_ELEMENTS).TABS){
        element.classList.remove((0, _uiElementsJs.CLASS).ACTIVE_TAB);
        element.classList.add((0, _uiElementsJs.CLASS).INACTIVE_TAB);
        if (element.dataset.tab === tabButton) {
            element.classList.add((0, _uiElementsJs.CLASS).ACTIVE_TAB);
            element.classList.remove((0, _uiElementsJs.CLASS).INACTIVE_TAB);
        }
    }
};

},{"./localstorage.js":"jmgzH","./utils.js":"f0dxl","./API.js":"2ruPS","./ui_elements.js":"16ipr","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jmgzH":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "currentCity", ()=>currentCity);
parcelHelpers.export(exports, "cityFavoriteList", ()=>cityFavoriteList);
parcelHelpers.export(exports, "isCityExist", ()=>isCityExist);
parcelHelpers.export(exports, "addCity", ()=>addCity);
parcelHelpers.export(exports, "deleteCity", ()=>deleteCity);
parcelHelpers.export(exports, "updateCurrentCity", ()=>updateCurrentCity);
parcelHelpers.export(exports, "checkInput", ()=>checkInput);
var _errorsJs = require("./errors.js");
const storage = {
    saveFavoriteCities (cityFavoriteList) {
        try {
            localStorage.setItem("cityFavoriteList", JSON.stringify(Array.from(cityFavoriteList)));
        } catch (error) {
...
const checkInput = (value)=>{
    try {
        (0, _errorsJs.isInputValid)(value);
        return getFirstUpperCase(value);
    } catch (error) {
        if (error instanceof (0, _errorsJs.ValidInputError)) console.log(error.message);
        else throw error;
    }
};
...
const getFirstUpperCase = (str)=>{
    if (isLowerCase(str)) return str[0].toUpperCase() + str.slice(1);
    if (isUpperCase(str)) return str[0].toUpperCase() + str.slice(1).toLowerCase();
    return str;
};

},{"./errors.js":"7mjSb","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7mjSb":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "ValidInputError", ()=>ValidInputError);
parcelHelpers.export(exports, "isInputValid", ()=>isInputValid);
...
const isInputValid = (str)=>{
    if (!str || str.trim() === "" || !isNaN(str)) throw new ValidInputError("Введите корректное название города");
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"f0dxl":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "convertKelvinToCelsius", ()=>convertKelvinToCelsius);
parcelHelpers.export(exports, "convertUnixToTime", ()=>convertUnixToTime);
parcelHelpers.export(exports, "convertUnixToDate", ()=>convertUnixToDate);
var _dateFns = require("date-fns");
const convertKelvinToCelsius = (temperature)=>`${Math.round(temperature - 273.15)}°`;
const convertUnixToTime = (time)=>{
    const parseTime = new Date(time * 1000);
    const outputTime = (0, _dateFns.format)(parseTime, "hh:mm");
    return outputTime;
};
const convertUnixToDate = (date)=>{
    const parseDate = new Date(date * 1000);
    const outputDate = (0, _dateFns.format)(parseDate, "d MMMMMMMM");
    return outputDate;
};
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2ruPS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "API", ()=>API);
parcelHelpers.export(exports, "API_LOG", ()=>API_LOG);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["14wWz","ELZjx"], "ELZjx", "parcelRequirefe52")

//# sourceMappingURL=index.5b825658.js.map
