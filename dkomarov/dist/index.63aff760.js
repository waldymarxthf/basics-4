...
var _converterTimeJs = require("./modules/converterTime.js");
var _domconstantsJs = require("./modules/DOMconstants.js");
function clearInput() {
    return (0, _domconstantsJs.inputValue).value = "";
}
(0, _domconstantsJs.tabs).forEach((tab, index)=>{
    tab.addEventListener("click", ()=>{
        (0, _domconstantsJs.tabs).forEach((t)=>t.classList.remove("active-tab"));
        (0, _domconstantsJs.displayItem).forEach((el)=>el.classList.remove("active"));
        tab.classList.add("active-tab");
        (0, _domconstantsJs.displayItem)[index].classList.add("active");
    });
});
...
function createDisplayDetails(data) {
    ...
    const sunriseValue = (0, _converterTimeJs.convTime)(data.sys.sunrise, data.timezone, "HH:mm");
    sunrise.textContent = sunriseValue;
    const sunsetValue = (0, _converterTimeJs.convTime)(data.sys.sunset, data.timezone, "HH:mm");
...
function getStorItem() {
    if (listStorage) return JSON.parse(listStorage);
    else return null;
}
function addCity() {
    const name = (0, _domconstantsJs.nameShapeCity).textContent;
    array.add({
        city: name
    });
...
function deleteCity(text) {
    for (let key of array)if (key.city === text) array.delete(key);
    console.log(array);
    localStorage.setItem("array", JSON.stringify([
        ...array
    ]));
...
function render() {
    (0, _domconstantsJs.sectionItem).innerHTML = "";
    for (let obj of array)createElement((0, _domconstantsJs.sectionItem), obj.city);
}
...
//     };
// };
(0, _domconstantsJs.formNode).addEventListener("submit", (e)=>{
    const cityNames = (0, _domconstantsJs.inputValue).value;
    e.preventDefault();
    getRequest(cityNames);
});
(0, _domconstantsJs.addButtonShape).addEventListener("click", ()=>{
    addCity();
// checkShape();
});
...
},{"./modules/converterTime.js":"gSt6X","./modules/DOMconstants.js":"iFxyV"}],"gSt6X":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "convTime", ()=>convTime);
var _dateFns = require("date-fns");
function convTime(time, timeZone, dateStandard) {
    const date = new Date((time + timeZone) * 1000);
    if (dateStandard === "HH:mm") return (0, _dateFns.format)(date, dateStandard);
    if (dateStandard === "MMM dd") return (0, _dateFns.format)(date, dateStandard);
}
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iFxyV":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "tabs", ()=>tabs);
parcelHelpers.export(exports, "displayItem", ()=>displayItem);
parcelHelpers.export(exports, "inputValue", ()=>inputValue);
parcelHelpers.export(exports, "formNode", ()=>formNode);
parcelHelpers.export(exports, "nameShapeCity", ()=>nameShapeCity);
parcelHelpers.export(exports, "addButtonShape", ()=>addButtonShape);
parcelHelpers.export(exports, "sectionItem", ()=>sectionItem);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["lmKb7","adjPd"], "adjPd", "parcelRequire291a")
