...
})({"jeyng":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "9241324daa284a3a";
"use strict";
...
},{}],"2XlbQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getData", ()=>getData);
parcelHelpers.export(exports, "timeConverterTime", ()=>timeConverterTime);
parcelHelpers.export(exports, "timeConverter", ()=>timeConverter);
parcelHelpers.export(exports, "cityExistsInCache", ()=>cityExistsInCache);
parcelHelpers.export(exports, "findIndexCityInCache", ()=>findIndexCityInCache);
parcelHelpers.export(exports, "saveToLocalStorage", ()=>saveToLocalStorage);
parcelHelpers.export(exports, "findCityIndex", ()=>findCityIndex);
parcelHelpers.export(exports, "isEmpty", ()=>isEmpty);
var _dateFns = require("date-fns");
async function getData(URL) {
    try {
        const response1 = await fetch(URL);
        let ans = await response1.json();
        return ans;
    } catch (error) {
...
function timeConverter(UNIX_timestamp, date_format) {
    const date = new Date(UNIX_timestamp * 1000);
    const result = (0, _dateFns.format)(date, date_format);
    return result;
}
function cityExistsInCache(cache, name) {
    const now = new Date().getHours();
    const cityExist = cache.find((item)=>item.data.name.toLowerCase() === name) !== undefined;
    let dateGood = false;
    for(let i = 0; i < cache.length; i++)if (cache[i].time === now && cache[i].data.name.toLowerCase() === name) {
        dateGood = true;
        break;
    }
    return [
...
function findIndexCityInCache(cache, name) {
...
const findCityIndex = (list, name)=>{
    name = name.toLowerCase();
    return list.findIndex((c)=>c.name === name);
};
const isEmpty = (cityName)=>cityName.trim();
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["jeyng","2XlbQ"], "2XlbQ", "parcelRequire7727")

//# sourceMappingURL=index.aa284a3a.js.map
