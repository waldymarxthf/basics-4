...
if (localStorage.getItem("right_bottom_content")) right_bottom_content.innerHTML = localStorage.getItem("right_bottom_content");
...
async function createElement2(city) {
    let array = await (0, _fetchJs.calculations)();
    console.log(array);
...
async function Likes(event) {
    ...
    const data = await (0, _fetchJs.fetchLikes)(p);
    console.log(data);
...
},{"./fetch.js":"crVZ2"}],"crVZ2":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "fetchServer", ()=>fetchServer);
parcelHelpers.export(exports, "fetchLikes", ()=>fetchLikes);
parcelHelpers.export(exports, "calculations", ()=>calculations);
const city = document.querySelector(".input");
const serverUrl = "http://api.openweathermap.org/data/2.5/weather";
const apiKey = "afc9f2df39f9e9e49eeb1afac7034d35";
...
},{}]},["lmKb7","adjPd"], "adjPd", "parcelRequire9681")
