...
function submitForm(e) {
    e.preventDefault();
    textInput = (0, _domJsDefault.default).input.value;
    spliceText(textInput);
}
function RenderTimeLeft(left) {
    (0, _domJsDefault.default).txt.textContent = left[0] + " лет " + left[1] + " дней " + left[2] + " часа ";
}
function chechOnToDay(dates) {
    if (now[1] == dates[1]) return dates[2] - now[2];
    else return dates[2] - now[2] - 1;
}
function spliceText(text) {
    if (text !== "") {
        const dates = text.split("-");
        if (now[0] > dates[0] || now[1] > dates[1] || now[2] > dates[2]) console.error((0, _errorsJsDefault.default).errorDateSmoll);
        else {
            const left = [
                dates[0] - now[0],
                chechOnToDay(dates),
...
(0, _domJsDefault.default).button.addEventListener("click", submitForm);

},{"./dom.js":"g0i6x","./errors.js":"4JFAL","@parcel/transformer-js/src/esmodule-helpers.js":"UfkhH"}],"g0i6x":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const errorClearInput = "поле пустое";
const errorDateSmoll = "дата меньше чем сейчас";
exports.default = {
    errorClearInput,
    errorDateSmoll
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"UfkhH"}]},["7piNH","jUTag"], "jUTag", "parcelRequire4482")
