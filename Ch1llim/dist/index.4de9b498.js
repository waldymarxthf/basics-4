...
let cityMain = (0, _localJs.getLS)("city");
let list = [];
...
async function getCityRequest(city) {
    ...
    cityMain = city;
    (0, _localJs.setLS)(cityMain, "city");
...
function renderDetails(data) {
    ...
    const sunriseText = (0, _dateFns.format)((0, _dateFns.fromUnixTime)(data.sys.sunrise), "kk:m");
    const sunsetText = (0, _dateFns.format)((0, _dateFns.fromUnixTime)(data.sys.sunset), "kk:m");
...
function addFav() {
    ...
    setList.add(city);
    list = Array.from(setList);
    (0, _localJs.setLS)(list, "list");
    renderList();
}
...
function actionSearchArr(list, num, ul) {
    if (num < 0) return;
    let item = list[num - 1];
    ...
    ul.append(li);
    li.append(divDel);
    return actionSearchArr(list, num - 1, ul);
}
function renderList() {
    const ul = document.querySelector(".weather-right-info-list");
    ul.innerHTML = "";
    list = (0, _localJs.getLS)("list");
    if (!Array.isArray(list)) list = [];
    actionSearchArr(list, list.length, ul);
}
...
},{"./local.js":"8aGNI","date-fns":"9yHCA"}],"8aGNI":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "setLS", ()=>setLS);
parcelHelpers.export(exports, "getLS", ()=>getLS);
function setLS(data, name) {
...
},{"../toDate/index.js":"fsust","../_lib/toInteger/index.js":"f7kKX","../_lib/requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["kXTO7","4pp4s"], "4pp4s", "parcelRequired108")
