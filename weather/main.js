...
const filteredArr =Array.from (mySet);
function addTask(text) {
    filteredArr.push(text);
    localStorage.setItem('array', JSON.stringify(filteredArr))
};
...
function deleteCity(text) {
    const indexItem = filteredArr.findIndex(e => e.city === text)
