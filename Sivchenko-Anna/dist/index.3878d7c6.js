...
})({"dFruI":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "6da22d593878d7c6";
"use strict";
...
},{}],"994m5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "favoriteCities", ()=>favoriteCities);
...
var _locale = require("../node_modules/date-fns/locale");
const today = (0, _dateFns.format)(new Date(), "'Today is a' eeee");
const todayLong = (0, _dateFns.format)(new Date(), "'Today is a' PPPPpppp");
const result1 = (0, _dateFns.format)(new Date(2000, 0, 0), "MMMM");
const result2 = (0, _dateFns.format)(new Date(2000, 0, 1), "MMMM");
const bDay = (0, _dateFns.format)(new Date(1999, 1, 24), "d/MMM/YYY");
console.log(today);
...
console.log(bDay);
for(let i = 1; i < 8; i++){
    const daysAgo = (0, _dateFns.formatDistance)((0, _dateFns.subDays)(new Date(), i), new Date(), {
        addSuffix: true
    });
    console.log(daysAgo);
}
const enFormat = (0, _dateFns.formatRelative)((0, _dateFns.subDays)(new Date(), 3), new Date());
const ruFormat = (0, _dateFns.formatRelative)((0, _dateFns.subDays)(new Date(), 3), new Date(), {
    locale: (0, _locale.ru)
});
...
function addFavoriteCity() {
    ...
    if ((0, _utilsJs.isCityExist)(favoriteCity)) {
    ...
    (0, _storageJs.saveFavoriteCitiesInlocalStorage)(favoriteCities);
    render();
}
//* функция удаления города из массива
function removeFavoriteCity(city) {
    const index = (0, _utilsJs.findIndex)(city);
...
function cleateElement(city) {
    ...
    favoriteCity.addEventListener("click", ()=>{
        (0, _apiJs.updateWeatherInfo)(city.location);
...
async function showWeather(event) {
    ...
    const city = (0, _variablesJs.UI_ELEMENTS).INPUT_NAME.value;
    if ((0, _utilsJs.isInputEmpty)(city)) {
        alert("Введите название города");
        return;
    }
    (0, _apiJs.updateWeatherInfo)(city);
    (0, _storageJs.saveCurrentCityInLocalStorage)(city);
    (0, _utilsJs.cleanInput)();
}
(0, _variablesJs.UI_ELEMENTS).FORM.addEventListener("submit", showWeather);
(0, _variablesJs.UI_ELEMENTS).BTN_FAVORITE.addEventListener("click", addFavoriteCity);
window.addEventListener("DOMContentLoaded", render);

},{"./variables.js":"g1juc","./api.js":"jCGgd","./utils.js":"Z7hmX","./storage.js":"a4cNs","../node_modules/date-fns":"9yHCA","../node_modules/date-fns/locale":"lASMG","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"g1juc":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}],"jCGgd":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
parcelHelpers.export(exports, "setWeatherNow", ()=>setWeatherNow);
// * функция установки данных погоды в раздел Details
parcelHelpers.export(exports, "setWeatherDetails", ()=>setWeatherDetails);
//* функция обновления данных о погоде (получение + установка)
parcelHelpers.export(exports, "updateWeatherInfo", ()=>updateWeatherInfo);
var _variablesJs = require("./variables.js");
var _utilsJs = require("./utils.js");
async function getWeather(city) {
    try {
        const url = `${(0, _variablesJs.API).SERVER_URL}?q=${city}&appid=${(0, _variablesJs.API).API_KEY}&units=metric`;
...
function setWeatherNow(data) {
    ...
    (0, _variablesJs.WEATHER).NOW.TEMPERATURE.textContent = `${Math.round(main.temp)}°`;
    const icon = weather[0].icon;
    const iconSrc = `https://openweathermap.org/img/wn/${icon}@2x.png`;
    (0, _variablesJs.WEATHER).NOW.ICON.src = iconSrc;
    (0, _variablesJs.WEATHER).NOW.CITY_NAME.textContent = name;
}
function setWeatherDetails(data) {
    (0, _variablesJs.WEATHER).DETAILS.CITY_NAME.textContent = data.name;
    (0, _variablesJs.WEATHER).DETAILS.TEMPERATURE.textContent = `${Math.round(data.main.temp)}°`;
    (0, _variablesJs.WEATHER).DETAILS.FEELS_LIKE.textContent = `${Math.round(data.main.feels_like)}°`;
    (0, _variablesJs.WEATHER).DETAILS.SUNRISE.textContent = (0, _utilsJs.convertUnixTime)(data.sys.sunrise, data.timezone);
    (0, _variablesJs.WEATHER).DETAILS.SUNSET.textContent = (0, _utilsJs.convertUnixTime)(data.sys.sunset, data.timezone);
}
...
},{"./variables.js":"g1juc","./utils.js":"Z7hmX","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"Z7hmX":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
//* функция проверки на пустую строку
parcelHelpers.export(exports, "isInputEmpty", ()=>isInputEmpty);
...
parcelHelpers.export(exports, "cleanInput", ()=>cleanInput);
...
function findIndex(name) {
    return (0, _mainJs.favoriteCities).findIndex((item)=>item.location === name);
}
function isCityExist(name) {
    return (0, _mainJs.favoriteCities).find((item)=>item.location === name);
}
function convertUnixTime(time, timezone) {
...
function cleanInput() {
    (0, _variablesJs.UI_ELEMENTS).FORM.reset();
}

},{"./main.js":"994m5","./variables.js":"g1juc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"a4cNs":[function(require,module,exports) {
//* функция сохранения списка городов в localStorage
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "saveFavoriteCitiesInlocalStorage", ()=>saveFavoriteCitiesInlocalStorage);
//* функция получения списка городов из localStorage
parcelHelpers.export(exports, "getFavoriteCitiesFromlocalStorage", ()=>getFavoriteCitiesFromlocalStorage);
//* функция сохранения актуального города в localStorage
parcelHelpers.export(exports, "saveCurrentCityInLocalStorage", ()=>saveCurrentCityInLocalStorage);
//* функция получения актуального города в localStorage
parcelHelpers.export(exports, "getCurrentCityFromlocalStorage", ()=>getCurrentCityFromlocalStorage);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"k1fV5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../addDays/index.js":"g6fAH","../_lib/requiredArgs/index.js":"9wUgQ","../_lib/toInteger/index.js":"f7kKX","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lASMG":[function(require,module,exports) {
// This file is generated automatically by `scripts/build/indices.ts`. Please, don't change it.
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../../../_lib/buildMatchFn/index.js":"2nEf9","../../../_lib/buildMatchPatternFn/index.js":"4GjCS","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["dFruI","994m5"], "994m5", "parcelRequire9681")

//# sourceMappingURL=index.3878d7c6.js.map
